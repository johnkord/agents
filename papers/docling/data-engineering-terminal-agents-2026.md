...
|------------------------|------------------------|------------------------|-----------------------------|-------------------------------|-------------------------|-------------------------|
| Model Accuracy         | GPT-5-Nano 7.90        | GPT-5-Mini 24.0        | Grok Code Fast 1 14.2       | Grok 4 23.1                   | Gemini 2.5 Flash 16.9   | Qwen3-Max-Thinking 22.5 |
...
| Model Size Accuracy    | Qwen3-32B 32B 3.37     | Qwen3-Coder 480B 23.9  | GPT-OSS (high) 20B 20B 3.10 | GPT-OSS (high) 120B 120B 18.7 | Nemotron-T-14B 14B 20.2 | Nemotron-T-32B 32B 27.4 |
...
initial Qwen3 baselines, reaching competitive performance with significantly larger models while requiring only modest computational resources for training and inference. For example, our NemotronTerminal-32B outperforms Qwen3-Coder-480B (Yang et al., 2025) on Terminal-Bench 2.0 (27.4 ± 2.4 vs. 23.9 ± 2.8). We release Nemotron-Terminal models and Terminal-Corpus dataset at https: //huggingface.co/collections/nvidia/nemotron-terminal .
...
```
task_directory/ instruction.md task.toml environment/ Dockerfile ... solution/ solve.sh ... tests/ test.sh ...
```
...
Figure 3: Terminus 2 agent response format. The Terminus 2 agent scaffold prompts the model to output responses in a JSON format, which includes: analysis , plan , commands , and task\_complete .
...
| LiveCodeBench v6     |           67.2  |
| SWE-bench Verified   |           52.4  |
...
We first decontaminate our SFT dataset by removing any prompt that has a 14-gram overlap with TerminalBench 2.0 test samples. Then, we apply various quality filters, including removing identity leaks and discarding responses that contain Chinese characters.
...
We evaluate Terminal-Task-Gen by benchmarking NemotronTerminal on Terminal-Bench 2.0 (TB2.0). As shown in Table 3, our models demonstrate substantial gains: NemotronTerminal-8B achieves 13 . 0 ± 2 . 2 , a five-fold increase over Qwen3-8B ( 2 . 47 ± 0 . 5 ). Remarkably, despite their modest scale, they rival significantly larger systems; Nemotron-Terminal-14B ( 20 . 2 ± 2 . 7 ) outperforms the 120B GPT-OSS ( 18 . 7 ± 2 . 7 ) and
...
| Gemini 2.5 Pro        | -                    | 32.6 ± 3.0           |
| Gemini 3 Flash        | -                    | 51.7 ± 3.1           |
| Gemini 3 Pro          | -                    | 56.9 ± 2.5           |
| Claude Haiku 4.5      | -                    | 28.3 ± 2.9           |
| Claude Sonnet 4.5     | -                    | 42.8 ± 2.8           |
| Claude Opus 4.5       | -                    | 57.8 ± 2.5           |
| Open Source Models    | Open Source Models   | Open Source Models   |
| Qwen3-8B              | 8B                   | 2.47 ± 0.5           |
| Qwen3-14B             | 14B                  | 4.04 ± 1.3           |
| Qwen3-32B             | 32B                  | 3.37 ± 1.6           |
| Qwen3-Coder           | 480B                 | 23.9 ± 2.8           |
| GPT-OSS (high)        | 20B                  | 3.10 ± 1.5           |
| GPT-OSS (high)        | 120B                 | 18.7 ± 2.7           |
| MiniMax M2            | 230B                 | 30.0 ± 2.7           |
| MiniMax M2.1          | 230B                 | 29.2 ± 2.9           |
| Kimi K2 Thinking      | 1T                   | 35.7 ± 2.8           |
| DeepSeek-V3.2         | 685B                 | 38.2 ± 2.9           |
| Ours                  | Ours                 | Ours                 |
...
| Math             | 162,692          | 5.39 ± 1.65 |
| Code             | 31,960           | 6.29 ± 1.65 |
| SWE              | 31,661           | 7.02 ± 2.13 |
| All              | 226,313          | 9.66 ± 2.11 |
| Synthetic Tasks  | Synthetic Tasks  |             |
| Seed-based       | 124,366          | 6.18 ± 1.91 |
| Skill-based      | 139,841          | 12.4 ± 2.38 |
...
|---------------|-------------|-------------|
| Math          |             |             |
| Complete-only | 147,718     | 7.19 ± 1.87 |
| No filter     | 162,692     | 5.39 ± 1.65 |
| Code          |             |             |
| Complete-only | 20,169      | 6.07 ± 1.73 |
| No filter     | 31,960      | 6.29 ± 1.65 |
| SWE           |             |             |
| Complete-only | 29,053      | 5.39 ± 1.68 |
| No filter     | 31,661      | 7.02 ± 2.13 |
| All           |             |             |
| Complete-only | 196,940     | 8.09 ± 1.84 |
| No filter     | 226,313     | 9.66 ± 2.11 |
...
Table 8: Impact of SFT sequence length and YaRN2 scaling on Qwen3-8B performance. Wefind that training and evaluating with default Qwen3 context settings yields the strongest performance.

| Filter        | # Samples   | TB2.0       |
|---------------|-------------|-------------|
| Complete-only | 104,603     | 6.74 ± 2.20 |
| Success-only  | 83,448      | 5.06 ± 2.11 |
| No filter     | 264,207     | 12.4 ± 2.29 |
...
Table 9: Ablations on curriculum learning strategies. Wecompare a mixed single-stage strategy with a two-stage curriculum. The mixed strategy achieves the strongest performance.

| Model    | Strategy   | TB2.0        |
|----------|------------|--------------|
| Qwen3-8B | mixed      | 13.03 ± 2.16 |
| Qwen3-8B | curriculum | 10.39 ± 1.71 |
...
- [8] DCAgent. bash\_textbook\_tasks\_traces. https://huggingface.co/datasets/DCAgent/bash\_ textbook\_tasks\_traces , 2025. 2, 3
...
- [21] MAA. Aime 2024 benchmark: Problems from the american invitational mathematics examination. https: //huggingface.co/datasets/Maxwell-Jia/AIME\_2024 , 2024. Benchmark of AIME 2024 problems for evaluating mathematical reasoning in language models. 7
- [22] MAA. Aime 2025 benchmark: Problems from the american invitational mathematics examination. https: //ukgovernmentbeis.github.io/inspect\_evals/evals/mathematics/aime2025/ , 2025. Benchmark of AIME 2025 problems for evaluating mathematical reasoning in language models. 7
...
|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| Security              | Systems, Data Processing, Web Security, Al- gorithmic, Testing                                                                        | Craft exploit payloads to bypass authentica- tion and identify vulnerabilities             |
| Software Engineering  | Algorithmic, Systems, Data Processing, Web Security, Testing, Mathematical                                                            | Implement graph traversal (BFS/DFS) for de- pendency resolution                            |
| File Operations       | File I/O, Navigation, Data Parsing, Transfor- mation, Archives, Resources, Network                                                    | Parse structured formats (JSON/XML/CSV) with encoding and validation                       |
...
| Data Science          | Systems, Data Processing, Algorithmic, Math- ematical, Testing, Web Security                                                          | Load and transform tabular data with groupby, filtering, and aggregation                   |
...
| Data Processing       | Data I/O, Manipulation, String/Text, Algo- rithmic, Mathematical, Time Series, Systems, Testing                                       | Build transformation pipelines with interpo- lation and feature extraction                 |
| System Administration | Filesystem, Process/Service, Network, Con- figuration, Deployment, Data Processing, Se- curity, Shell Scripting, Testing, Algorithmic | Manage file permissions, configure services, and automate tasks with shell scripts         |
...
We use Terminus 2 to generate all trajectories for SFT. We provide the full Terminus 2 system prompt template in Figure 7, which includes placeholders for instruction and terminal\_state . Our Terminal-Task-Gen pipeline generates tasks with explicit instructions that replace the instruction placeholder. For dataset adapters, we instead insert the original prompt followed by a domain-specific suffix, shown in Figures 8-10. The terminal\_state placeholder is populated with the latest terminal output summarizing the current shell state.
...
You are an expert at creating ⟨ domain ⟩ tasks for AI agent training.

## 2. Domain Context (Insert Variable Module Here):

[INSERT CONTENT FROM SPECIFIC DOMAIN TABLES BELOW (e.g., Data Science, Security, etc.)]
...
You MUST output using these XML tags:
...
- -⟨ info ⟩ : Task metadata.
- -⟨ fi les ⟩ : Input data or initial file structure.
- -⟨ test\_requirements ⟩ : Python packages required for testing.
...
```
# Task Generation Request Category: ⟨ CATEGORY ⟩ ## Primitive Skills (Building Blocks) ⟨ Primitive_Skills ⟩ ## Pre-designed Docker Environment Tasks will run in this pre-designed Docker environment: ⟨ DOCKERFILE_CONTENT ⟩ If additional packages are needed for testing, list them in ⟨ test_requirements ⟩ . ## Instructions CREATE A NOVEL TASK that:
```
...
4. Has clear, unambiguous specifications

Think of an original scenario or application - don't just combine primitives mechanically.
...
You are an expert at creating data processing programming tasks for AI agent training.
...
Create a programming task that tests data processing skills. The task should be:
...
You are an expert at creating data querying programming tasks for AI agent training.
...
Create a programming task that tests data querying skills. The task should be:
...
You are an expert at creating data science programming tasks for AI agent training.
...
Create a programming task that tests data science skills. The task should be:
...
You are an expert at creating debugging programming tasks for AI agent training.
...
Create a programming task that tests debugging skills. The task should be:
...
You are an expert at creating file operations programming tasks for AI agent training.
...
Create a programming task that tests file operations skills. The task should be:
...
You are an expert at creating scientific computing programming tasks for AI agent training.
...
Create a programming task that tests scientific computing skills. The task should be:
...
You are an expert at creating security programming tasks for AI agent training.
...
Create a programming task that tests security skills. The task should be:
...
You are an expert at creating software engineering programming tasks for AI agent training.
...
- **Version control**: Git operations, merge conflicts
- **API design**: REST, GraphQL, protocol design
- **Architecture**: Patterns, modularity, scalability

## Your Task

Create a programming task that tests software engineering skills. The task should be:
...
You are an expert at creating system administration programming tasks for AI agent training.
...
Create a programming task that tests system administration skills. The task should be:
