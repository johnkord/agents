...
echo "   dotnet run --model \"gpt-4o\" --temperature 0.7 --priority High --max-iterations 3 --verbose \"Create a short poem about technology\""
echo ""
...
echo "|-------------------|-------|---------------------------------|---------------------|"
echo "| --model           | -m    | OpenAI model to use            | gpt-4o              |"
